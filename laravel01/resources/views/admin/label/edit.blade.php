...
@section("title","修改標籤")
@section("content")
<form method="post" action="/admin/label/update">
<!-- <form method="post" action="../update"> : 為另一種寫法-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <label class="col-form-label col-1 col-sm-1 col-md-2 col-lg-1 text-right">標籤</label>
                <div class="col-2 col-sm-2">
                    <input type="text" class="form-control" name="label" value="{{ $label->labels }}">
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-2 col-sm-2">
                    <input type="text" class="form-control" name="content" value="{{ $label->content }}">
                </div>
            </div>
